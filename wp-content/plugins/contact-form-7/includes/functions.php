...
{
	if (is_page(41)) {
		wp_enqueue_script('contactform7confirmjs', '/Applications/MAMP/htdocs/base_mochikaeri/wp-content/plugins/contact-form-7/confirm/contact-form7-confirm.js');
		wp_enqueue_style('contactform7confirmcss', '/Applications/MAMP/htdocs/base_mochikaeri/wp-content/plugins/contact-form-7/confirm/contact-form7-confirm.css');
	}
}
add_action('wp_head', 'contact_script');


// /Applications/MAMP/htdocs/base_mochikaeri/wp-content/plugins/contact-form-7/confirm
// /Applications/MAMP/htdocs/base_mochikaeri/wp-content/plugins/contact-form-7/confirm 
