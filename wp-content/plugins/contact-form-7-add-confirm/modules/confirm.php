...
if (WPCF7_VERSION >= "4.2.0") {
	...
	function wpcf7c_add_tag_generator_confirm()
	{
		...
		$tag_generator->add(
			'confirm',
			__('Confirm button', 'contact-form-7-add-confirm'),
			'wpcf7c_tg_pane_confirm',
			array('nameless' => 1)
		);
	}
		...
		<div class="control-box">
			<fieldset>
				...
				<table class="form-table">
					<tbody>
						<tr>
							<th scope="row"><label for="<?php echo esc_attr($args['content'] . '-values'); ?>"><?php echo esc_html(__('Label', 'contact-form-7')); ?></label>
							</th>
						...
						<tr>
							<th scope="row"><label for="<?php echo esc_attr($args['content'] . '-class'); ?>"><?php echo esc_html(__('Class attribute', 'contact-form-7')); ?></label>
							</th>
